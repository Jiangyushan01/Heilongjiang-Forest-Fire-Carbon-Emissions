...
# ============================================================
# 5. Calculate annual CO2 emissions
# ============================================================

def calculate_co2_for_year(year):
    ...
    print(
        f"\nStarting CO2 emission calculation "
        f"for {year}..."
    )
    ...
    for month_data in months_data:
        ...
        try:
            ...
            for code, factor in emission_factors_co2.items():

                emission_factor[
                    (landcover == code) & valid_mask
                ] = factor

            co2_emission[valid_mask] = (
            ...
            valid_co2 = co2_emission[valid_mask]
