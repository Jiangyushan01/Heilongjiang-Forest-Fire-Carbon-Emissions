...
# ============================================================
# 5. Calculate annual CO emissions
# ============================================================

def calculate_co_for_year(year):
    ...
    print(
        f"\nStarting CO emission calculation "
        f"for {year}..."
    )
    ...
    for month_data in months_data:
        ...
        try:
            ...
            for code, factor in emission_factors_co.items():

                emission_factor[
                    (landcover == code) & valid_mask
                ] = factor

            co_emission[valid_mask] = (
            ...
            valid_co = co_emission[valid_mask]
